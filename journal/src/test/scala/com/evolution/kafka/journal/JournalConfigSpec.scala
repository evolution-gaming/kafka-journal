  ...
  test("apply from config") {
    ...
    val expected = JournalConfig(
      ...
      kafka = default
        ...
        .copy(
          producer =
            default.kafka.producer.copy(common = default.kafka.producer.common.copy(clientId = "clientId".some)),
          consumer =
            default.kafka.consumer.copy(common = default.kafka.consumer.common.copy(clientId = "clientId".some)),
        ),
