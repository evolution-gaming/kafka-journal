...
object Journals {
  ...
  def apply[F[_]: Concurrent : Clock : RandomIdOf : Fail : JsonCodec : smetrics.MeasureDuration](
    origin: Option[Origin],
    producer: Producer[F],
  ...
  def apply1[F[_]: Concurrent : Clock : RandomIdOf : Fail : JsonCodec : MeasureDuration](
    origin: Option[Origin],
    producer: Producer[F],
    consumer: Resource[F, Consumer[F]],
    eventualJournal: EventualJournal[F],
  ...
  @deprecated("Use `apply1` instead", "0.2.1")
  def apply[F[_] : Concurrent : RandomIdOf : smetrics.MeasureDuration](
  ...
  def apply1[F[_] : Concurrent : RandomIdOf : MeasureDuration](
    eventual: EventualJournal[F],
    consumeActionRecords: ConsumeActionRecords[F],
    produce: Produce[F],
    headCache: HeadCache[F],
