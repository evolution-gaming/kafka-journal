...
object HeadCache {
  ...
  def of[F[_]: Concurrent: Parallel: Timer: Runtime: LogOf: KafkaConsumerOf: smetrics.MeasureDuration: FromTry: FromJsResult: JsonCodec.Decode](
  ...
  def of1[F[_]: Concurrent: Parallel: Timer: Runtime: LogOf: KafkaConsumerOf: MeasureDuration: FromTry: FromJsResult: JsonCodec.Decode](
    consumerConfig: ConsumerConfig,
    eventualJournal: EventualJournal[F],
    metrics: Option[HeadCacheMetrics[F]]
  ): Resource[F, HeadCache[F]] = {
  ...
  @deprecated("Use `of1` instead", "0.2.1")
  def of[F[_]: Concurrent: Parallel: Timer: Runtime: FromJsResult: smetrics.MeasureDuration: JsonCodec.Decode](
    eventual: Eventual[F],
    log: Log[F],
  ...
  def of1[F[_]: Concurrent: Parallel: Timer: Runtime: FromJsResult: MeasureDuration: JsonCodec.Decode](
    eventual: Eventual[F],
    log: Log[F],
    consumer: Resource[F, TopicCache.Consumer[F]],
    metrics: Option[HeadCacheMetrics[F]],
