...
object HeadCacheOf {
  ...
  def apply[F[_] : Concurrent : Parallel : Timer : LogOf : KafkaConsumerOf : MeasureDuration : FromTry : FromAttempt : FromJsResult](
    metrics: Option[HeadCacheMetrics[F]]
  )(implicit jsValueDecoder: JsValueDecoder): HeadCacheOf[F] = {
