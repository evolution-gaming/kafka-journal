...
/** Name of the host, which produced an event or a snapshot.
  *
  * There is no formal requirement of which name is to be used, so it could be `/etc/hostname`, IP address or even the
  * underlying actor system name.
  */
