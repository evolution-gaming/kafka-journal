...
class RowStub extends Row {
  ...
  override def getMap[K <: Object, V <: Object](i: Int, keysClass: Class[K], valuesClass: Class[V]): ju.Map[K, V] =
    notImplemented()
  override def getMap[K <: Object, V <: Object](i: Int, keysType: TypeToken[K], valuesType: TypeToken[V])
    : ju.Map[K, V] =
    notImplemented()
  ...
  override def getMap[K <: Object, V <: Object](name: String, keysClass: Class[K], valuesClass: Class[V])
    : ju.Map[K, V] =
    notImplemented()
  override def getMap[K <: Object, V <: Object](name: String, keysType: TypeToken[K], valuesType: TypeToken[V])
    : ju.Map[K, V] =
    notImplemented()
