...
private[journal] object Batch_4_1_2 {
  ...
  /**
   * Internal state used to collapse actions (aka Kafka records) into batches. Each batch represents
   * an action to be applied to Cassandra: `appends`, `delete` or `purge`.
   *
   * @param batches
