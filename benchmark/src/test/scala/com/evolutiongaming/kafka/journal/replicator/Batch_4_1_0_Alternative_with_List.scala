 ...
 */
private[journal] sealed abstract class Batch_4_1_0_Alternative_with_List extends Product {

  def offset: Offset
}

private[journal] object Batch_4_1_0_Alternative_with_List {

  def of(records: NonEmptyList[ActionRecord[Action]]): List[Batch_4_1_0_Alternative_with_List] = {
  ...
  ) extends Batch_4_1_0_Alternative_with_List
