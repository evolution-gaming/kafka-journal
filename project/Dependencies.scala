...
object Dependencies {
  ...
  val scassandra           = "com.evolutiongaming"    %% "scassandra"            % "2.0.2"
  val `cassandra-sync`     = "com.evolutiongaming"    %% "cassandra-sync"        % "1.0.4"
  ...
  val sstream              = "com.evolutiongaming"    %% "sstream"               % "0.0.9"
