...
object Dependencies {
  ...
  val hostname = "com.evolutiongaming" %% "hostname" % "0.3.0"
  val scassandra = "com.evolutiongaming" %% "scassandra" % "5.3.0"
  val `cassandra-sync` = "com.evolutiongaming" %% "cassandra-sync" % "3.1.0"
  val `cats-helper` = "com.evolutiongaming" %% "cats-helper" % "3.11.3"
  // TODO: WIP random changed orgId which might create runtime classloading issues with users
  // rename it back to com.evolutiongaming since most clients are on the old orgId?
