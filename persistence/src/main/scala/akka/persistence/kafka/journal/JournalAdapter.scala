...
object JournalAdapter {
  ...
  def of[
    ...
    def journal(eventualJournal: EventualJournal[F])(implicit
    ...
    } yield JournalAdapter[F, A](journal, toKey, serializer, journalReadWrite, appendMetadataOf).withBatching(batching)
  }
