...
import com.evolution.kafka.journal.akka.persistence.*
import com.evolution.kafka.journal.akka.persistence.EventSerializer.PersistentRepresentation
import com.evolution.kafka.journal.akka.persistence.circe.KafkaJournalCirce.*
