...
object EventSerializer {
   ...
   *
   * @param payload
   *   Non-serialized payload of an Akka message/event. See also [[PersistentRepr#payload]].
   * @param writerUuid
  ...
  /**
   * Serialize [[PersistentRepr]] to [[Payload]] using Akka serialization or Play JSON.
   *
   * @see
   ...
   * Akka serialization and create [[Payload.Binary]] for everything else.
   *
