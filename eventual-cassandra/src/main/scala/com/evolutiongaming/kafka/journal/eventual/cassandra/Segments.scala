...
/** The maximum number of segments in Cassandra table.
  *
  * When [[Segments]] is used then the segment column value is determined by consistent hashing of the key column. I.e.
  * there always no more than [[Segments#value]] different values.
  *
