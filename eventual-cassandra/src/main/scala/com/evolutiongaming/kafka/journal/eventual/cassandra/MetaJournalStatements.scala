...
object MetaJournalStatements {
  ...
  object IdByTopicAndExpireOn {
    ...
    def of[F[_] : Monad : CassandraSession](name: TableName)(implicit consistency: ConsistencyConfig.Read): F[IdByTopicAndExpireOn[F]] = {
      val query =
        s"""
  ...
  object IdByTopicAndCreated {
    ...
    def of[F[_] : Monad : CassandraSession](name: TableName)(implicit consistency: ConsistencyConfig.Read): F[IdByTopicAndCreated[F]] = {
      val query =
        s"""
           |SELECT id FROM ${ name.toCql }
           |WHERE topic = ?
  ...
  object IdByTopicAndSegment {
    ...
    def of[F[_] : Monad : CassandraSession](name: TableName)(implicit consistency: ConsistencyConfig.Read): F[IdByTopicAndSegment[F]] = {
      val query =
        s"""
           |SELECT id FROM ${ name.toCql }
           |WHERE topic = ?
  ...
  object UpdateExpiry {
    ...
    def of[F[_] : Monad : CassandraSession](name: TableName)(implicit consistency: ConsistencyConfig.Write): F[UpdateExpiry[F]] = {
      val query =
        s"""
           |UPDATE ${ name.toCql }
  ...
  object DeleteExpiry {
    ...
    def of[F[_] : Monad : CassandraSession](name: TableName)(implicit consistency: ConsistencyConfig.Write): F[DeleteExpiry[F]] = {
  ...
  object SelectIds {
    ...
    def of[F[_]: Monad: CassandraSession](name: TableName)(implicit consistency: ConsistencyConfig.Read): F[SelectIds[F]] = {
      for {
