...
object TopicReplicator {
  ...
  def of[F[_]: Concurrent: Sleep: ToTry: LogOf: Fail: smetrics.MeasureDuration: JsonCodec](
    topic: Topic,
  ...
  def of1[F[_]: Concurrent: Sleep: ToTry: LogOf: Fail: MeasureDuration: JsonCodec](
    topic: Topic,
    journal: ReplicatedJournal[F],
    consumer: Resource[F, TopicConsumer[F]],
    metrics: TopicReplicatorMetrics[F],
  ...
  @deprecated("Use `of1` instead", "2.2.0")
  def of[F[_]: Concurrent: Sleep: smetrics.MeasureDuration, A](
    topic: Topic,
    consumer: Resource[F, TopicConsumer[F]],
  ...
  def of1[F[_]: Concurrent: Sleep: MeasureDuration, A](
    topic: Topic,
    consumer: Resource[F, TopicConsumer[F]],
    consRecordToActionRecord: ConsRecordToActionRecord[F],
    kafkaRead: KafkaRead[F, A],
